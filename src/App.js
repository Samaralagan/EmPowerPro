      ...
      <Router>
        <Routes>
          ...
          <Route path="/" element={<Layout />}>
            ...
            <Route path="/Dash Board/TeamLeader/Performance" element={<Performance />}/>
            <Route path="/Dash Board/TeamLeader/Profile" element={<Profile />}/>
            ...
            <Route path="/Dash Board/Admin/Performance"element={<Performance />}/>
            ...
            <Route path="/Dash Board/HR/Performance"element={<Performance />} />
            ...
            <Route path="/Dash Board/FinanceAndSupport" element={<DashboardFinance />} />
            <Route path="/Dash Board/FinanceAndSupport/Performance" element={<Performance />}/>
            <Route path="/Dash Board/FinanceAndSupport/Profile"element={<Profile />}/>
            ...
            <Route path="/Dash Board/Executive/Performance" element={<Performance />}/>
            ...
            <Route path="/Employee/Executive/GenerateReport"element={<GenerateReport />}/>
            <Route path="/Employee/Executive/NewApproval" element={<NewApproval />}/>
            <Route path="/Employee/Executive/CreateNewTeam"element={<CreateNewTeam />}/>
            <Route path="/Employee/Executive/Profile" element={<Profile />} />
            <Route path="/Employee/Executive/Team_Profile" element={<Team_Profile />}/>
