                    ...
                    <table className="new-approval-custom-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Part-Time</td>
                                <td><button className="new-approval-resume"  onClick={ handleNewResume} > View Resume </button></td>
                                <td><button className="new-approval-ontime"> Pending </button></td>
                            </tr>
                            <tr>
                                <td>Diana Lovece</td>
                                <td>Android App  Developer</td>
                                <td>Part-Time</td>
                                <td><button className="new-approval-resume"> View Resume </button></td>
                                <td><button className="new-approval-ontime"> Pending </button></td>
