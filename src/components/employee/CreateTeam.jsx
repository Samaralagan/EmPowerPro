                ...
                <div className="create-team-body-2">
                    ...
                    <div className="create-team-form-box">
                        <div className="create-team-form-detail">
                            <label htmlFor="team-name" className="create-team-form-detail-topic">Team Name:</label>
                            <input id="team-name" className="create-team-form-input" />
                        </div>

                        <div className="create-team-form-detail">
                            <label htmlFor="project-description" className="create-team-form-detail-topic">Project Description:</label>
                            <input id="project-description" className="create-team-form-input-1" />
                        </div>

                        <div className="create-team-form-detail">
                            <label htmlFor="contributors" className="create-team-form-detail-topic">No. of Contributors:</label>
                            <input id="contributors" className="create-team-form-input" />
                        </div>

                        <div className="create-team-form-detail">
                            <label htmlFor="team-members" className="create-team-form-detail-topic">Team Members:</label>
                            <div className='create-team-apply-claim' onClick={handleAddTeamMember}>
                        ...
                        <div className="create-team-form-detail">
                            <label htmlFor="team-leader" className="create-team-form-detail-topic">Team Leader:</label>
                            <input id="team-leader" className="create-team-form-input" />
                        </div>

                        <div className="create-team-form-button-row">
                ...
                <div className="popup-overlay">
                    ...
                    <div className="popup">
                        ...
                        <div className="add-team-search-bar">
                            ...
                            <input type="text" placeholder="Search by Name or Role" className="add-team-search-input" />
