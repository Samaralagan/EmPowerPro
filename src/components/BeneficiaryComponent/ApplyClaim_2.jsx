    ...
    <div>
      ...
      <div className="applied-claim-body">
        ...
        <div className="form-box">
          ...
          <div className="upload-subtopic">Upload necessary documents like medical invoice and receipt for reimbursement.English translations are not necessary.You can save the form and return to it anytime</div>

          <div className="upload-box">
              <FaUpload size={50} className="upload-icon" />
              <p>Click to browse of drag and drop documents <br/>Acceptable file types are PDF, JPG etc.File size less than 10MB each</p>
            </div>
