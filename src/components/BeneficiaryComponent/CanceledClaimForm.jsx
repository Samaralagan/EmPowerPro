                ...
                <div className="applied-container">
                    ...
                    <div className="claimed-box">
                        ...
                        <div className="reason-row">
                            ...
                            <div className="claimed-applied-date">Claim raised on 23 May 2024 </div>
                        </div>

                        <div className="applied-subtopics">Reason :</div>
                        <div className="applied-content">In June 2024, I was hospitalized due to pneumonia. I was admitted to City General Hospital on June 1, 2024, and received comprehensive treatment including antibiotics, IV fluids, and oxygen therapy. After a 10-day stay, I was discharged on June 10, 2024.</div>
