    ...
    <div className="contentbodyall1">
        <div>
                <div className="project-box-top">
                  <p className="project-box-title" style={{marginTop:'2%'}}>Completed Tasks</p>
                  ...
                  {ProjectDone.map((card, index) => (
                    ...
                    >
                      ...
                      <div className="date-members">
                        <div className="project-card-date"  style={{ fontSize:'1.8vh' }}>
...
{/* 
            ...
            <p>
              ...
              <textarea className="share-textarea" placeholder="Enter your review..."></textarea>
