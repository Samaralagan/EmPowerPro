        ...
        <div className='dashboard-content'>
                ...
                <div className='dashboard-content-top-boxs'>
                    ...
                    <div className='dashboard-content-top-box'>
                        ...
                        <div className='dashboard-content-top-box-content' >
                            <div className='dashboard-content-top-box-text'>{data.timeContent}</div>
                            <div className='dashboard-content-top-box-data'>{data.time}</div>
                        </div>
                    </div>

                  <div className='dashboard-content-top-box'>
                        <div className='dashboard-content-top-box-icons'>
                            <div className='dashboard-content-top-box-icon' style={{backgroundColor:data.taskbody}}>
                               {<data.taskIcon  style={{color:data.taskcolor}}/>}
                            </div>
                        </div>
                        <div className='dashboard-content-top-box-content' >
                            <div className='dashboard-content-top-box-text'>{data.taskContent}</div>
                            <div className='dashboard-content-top-box-data'>{data.task}</div>
                        </div>
                    </div>

                    <div className='dashboard-content-top-box'>
                        <div className='dashboard-content-top-box-icons'>
                            <div className='dashboard-content-top-box-icon' style={{backgroundColor:data.teambody}}>
                               {<data.teamIcon  style={{color:data.teamcolor}}/>}
                            </div>
                        </div>
                        <div className='dashboard-content-top-box-content' >
                            <div className='dashboard-content-top-box-text'>{data.teamContent}</div>
                            <div className='dashboard-content-top-box-data'>{data.team}</div>
                        </div>
                    </div>
                  </div>
            ...
            <div className='dashboard-content-right'>
                ...
                <div className='dashboard-content-right-bottom'>
                    <div>
                        <DashboardCalendar initialMonth={new Date().getMonth()} initialYear={new Date().getFullYear()}/>
                    </div>
                    <div className='dashboard-content-right-bottom-events'>
                        {DashboardMarkTime.map((data,index)=>(
                          <div className='dashboard-content-right-bottom-event' key={index} >
                            <p>{data.date}</p>
                            <p>{data.name}</p>
                            <p>{data.time}</p>
                        </div>  
