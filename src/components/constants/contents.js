...
export const ABOUT = {
  ...
  title_text:
    "With a focus on quality, integrity, and continuous improvement ,we are dedicated to providing top-notch solutions<br/>tailored to meet the unique needs of our clients.",
  text1:
    "Founded in  2000 , EmpowerPro began with a simple mission: to transform the industry with innovative and reliable solutions. From our humble beginnings, we have grown into a leading company with a diverse portfolio and a strong commitment to excellence.our mission is to deliver high-quality products and services that exceed our clients' expectations. We are dedicated to continuous improvement, leveraging the latest technologies and best practices to stay ahead of the curve.",
  text2:
    "Our vision is to be a global leader in our industry, recognized for our innovation, customer-centric approach, and exceptional service. We aim to build long-lasting relationships with our clients by consistently delivering value and achieving outstanding results.",
  img1: about_img1,
  img2: about_img2,
  img3: about_img3,
  img4: about_img4,
...
export const EmployeeDashboard = [
  {
    ...
    timecolor: "#F37C98",
    timebody: "#FCD8E1",
    timeContent: "Today’s  In  Time",
    time: "8.16  AM",
    taskIcon: FaTasks,
    taskcolor: "#037A0F",
    taskbody: "#E1FCD8",
    taskContent: "Tasks in Progress",
    task: "11",
    teamIcon: MdGroups,
    teamcolor: "#FFBB00",
    teambody: "#FFF6DF",
    teamContent: "Team Members",
    team: "25",
  },
];
