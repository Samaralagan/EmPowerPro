    ...
    <div className="contentbodyall">
      <nav>
        <div className="nav nav-tabs mt-4" id="nav-tab" role="tablist">
          ...
          <button
            className={`nav-link ${
              activeTab === "BookMark-Blog" ? "active" : ""
            }`}
      ...
      <div>
        <div className="new-course-content mt-2">
          <div className="new-course-filterbar">
            <div className="new-course-filter" onClick={handleClickInput}>
              Filter
            </div>
            <input
              type="text"
          ...
          <div>
            ...
            {openBlog === card.blogId && (
              <ViewBlogPopup
                ...
                blogId={card.blogId}
                title={card.title}
                contant={card.content}
                modalIsOpen1={modalIsOpen1}
                closeModal1={closeModal1}
                addfavourite={
                  card.favourites.some((fav) => fav.userId === 1)
                    ? [
                        false,
                        card.favourites.find((fav) => fav.userId === 1)
                          .favouriteId,
                      ]
                    : [true, 0]
                }
