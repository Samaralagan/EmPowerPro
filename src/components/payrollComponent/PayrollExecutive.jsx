    ...
    <div className="payroll-body "> 
      ...
      <div className="" >
         ...
         <div>
            ...
            <label htmlFor="" className="fs-7 ">Select All</label>
         </div>
          <div >         
            ...
            {payrollDetailsData.map((card,index)=>(
              <div className="payroll-fs-content-data mt-2" key={index}>
                <div className="payroll-fs-content-data1" >
                    <div><input type="checkbox" className="me-2 mt-3 ms-3"/></div>
                ...
                <div className="payroll-fs-content-data41 " >{`View More>>`}</div>
              </div>
              ))}
            </div>
        </div>
