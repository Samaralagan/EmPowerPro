      ...
      <div className="">
        ...
        <div className="payroll-middle">
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ display: "flex", alignItems: "end", gap: "10px" }}>
              ...
              />
              <button className="gradient-blue-btn me-3" type="Submit">
                Enter
              </button>
            </div>
          </form>
          <button className="gradient-blue-btn me-3" onClick={openModal}>
            Fixed Rates
          </button>
        </div>
        ...
        <div className="payroll-content">
          ...
          <div className="payroll-content-details">
            ...
            <div className="payroll-content-row">
              <div className="payroll-content-col"></div>
            </div>
            {/* <div className="payroll-content-row">
                <div  className="payroll-content-col">
          ...
          <table className="salary-table ">
            ...
            <tr className="salary-table-td">
              ...
              <td className="salary-table-total">
                Rs.{data.medicalAllowance + data.otherAllowance + data.salary}
              </td>
              <td className="salary-table-total">
                Rs.{(data.incomeAfterTax + data.incomeAfterEpf).toFixed(2)}
              </td>
            </tr>
            <tr>
              ...
              <td colspan="2" className="salary-table-ns">
                {" "}
                NET SALARY
              </td>
            </tr>
