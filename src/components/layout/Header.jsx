      ...
      <div className="header-content">
        ...
        <div className="header-profile" >
          ...
          <div className={openDropDown}>
              <div className="header-dropdown-profile" onClick={() => handlePage(`Dash Board/${role}/Profile`)}><IoPerson className="me-1" />Profile</div>
              <div className="header-dropdown-logout" onClick={() => handlePage(`Login`)}><IoMdLogOut className="me-1" />Logout</div>
          </div>
          <div className={notification} >
            <center><h2 className="mt-3">Notification</h2></center>
              <hr />
              <br />
              <br />
              <center><p style={{color:'#D9D9D9'}}>Empty</p></center>
          </div>
        </div>
